...
export default function getMenuItems(T) {
    return [
        ...
        { separator: true },
        {
            label: T('File'),
            items: [
                { label: T('New'), event: 'new-mindmap' },
                { label: T('Export'), event: 'mindmap-export-file' },
                { label: T('Import'), event: 'mindmap-import-file' },
                { label: T('Export Image'), event: 'mindmap-export-image' },
                { label: T('Export SVG'), event: 'mindmap-export-svg' },
                // {
                //     label: T('More Export Options'), // Level 2
                //     items: [
                //         { label: T('Export Image'), event: 'mindmap-export-image' },
                //         { label: T('Export SVG'), event: 'mindmap-export-svg' },
                //         {
                //             label: T('Advanced Export'), // Level 3
                //             items: [
                //                 { label: T('Export with Watermark'), event: 'export-watermark' }, // Level 4
                //             ],
                //         },
                //     ],
                // },
